class Cast:
    ...
    # The responsibility of a cast is to keep track of a 
    # collection of actors. It has methods for adding, removing 
    # and getting them by a group name.
    """
    Attributes:
    ...
    def __init__(self):
        # This Constructs a new Actor."""
        self._actors = {}
        
    def add_actor(self, group, actor):
        # This adds an actor to the given group.
        """
        Args:
    ...
    def get_actors(self, group):
        # This gets the actors in the given group.
        """
        Args:
            group (string): The name of the group.
    ...
    def get_all_actors(self):
       # This gets all of the actors in the cast.
        """
        Returns:
    ...
    def get_first_actor(self, group):
        # This gets the first actor in the given group.
        """"
        Args:
            group (string): The name of the group.
    ...
    def remove_actor(self, group, actor):
        # This Removes an actor from the given group.
        """
        Args:
            group (string): The name of the group.
