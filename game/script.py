class Script:
    ...
    # The responsibility of Script is to keep track of a 
    # collection of actions. It has methods for adding, removing 
    ...
    def __init__(self):
        #This Constructs a new Action."""
        self._actions = {}
        
    def add_action(self, group, action):
        #This adds an action to the given group.
        """
        Args:
    ...
    def get_actions(self, group):
        # This Gets the actions in the given group.
        """
        Args:
            group (string): The name of the group.
    ...
    def remove_action(self, group, action):
        # This Removes an action from the given group.
        """
        Args:
            group (string): The name of the group.
